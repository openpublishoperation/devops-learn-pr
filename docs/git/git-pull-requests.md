...
always being in good shape, such as your `master` branch. [Require pull requests](/vsts/git/branch-policies) to make
...
### Learn more
Read more about [giving great feedback in code reviews](/vsts/repos/git/pull-requests#leave-comments) and
[usng pull request templates to provide guidance to your reviewers](/vsts/repos/git/pull-request-templates).
Visual Studio Team Services has a [rich pull request experience](/vsts/repos/git/pull-requests-overview) that’s
