...
changes to master. In an upcoming article, we’ll talk about [pull request policies](/azure/devops/git/branch-policies) that allow us to implement things like required tests, code reviewers, and
custom validation.
