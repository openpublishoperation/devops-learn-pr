...
[circuit breakers](/azure/architecture/patterns/circuit-breaker).
...
(XEvents)](/sql/analysis-services/instances/monitor-analysis-services-with-sql-server-extended-events)
