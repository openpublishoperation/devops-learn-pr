...
|             |                           |
|-------------|---------------------------|
|![Aaron Bjork](_img/Aaron-Bjork_avatar_1472225238.jpg)|Aaron is a Principal Group Program Manager at Microsoft where he drives investments in work management, agile project management, reporting, and collaboration for Microsoft’s Visual Studio Team Services (VSTS) and Team Foundation Server (TFS) products. |