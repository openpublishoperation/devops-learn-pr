...
artifact.
![FIGURE 1. DEVELOPER'S MOTIVATIONS FOR PERFORMING CODE REVIEWS. SOURCE:
\[1\]](_img/code-reviews-ranked-reasons.png)
...
![FIGURE 2. CODE REVIEW COMMENT CATEGORIES, THEIR FREQUENCY AND
USEFULNESS. SOURCE:
\[6\]](_img/code-reviews-categories.png)
