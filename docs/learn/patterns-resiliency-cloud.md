...
Transitions](_img/circuit-breaker-state.jpg)
...
breaker](_img/circuit-breaker-settings.png)
...
![circuit breaker
example](_img/circuit-breaker-example.png)
...
hitting the limits.
![throttle
impact](_img/screenshot-throttle-impact.png)
...
response headers.
![reacting on the
client](_img/reacting-on-the-client.png)
