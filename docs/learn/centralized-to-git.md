...
- Build and Test  
    ...
    so that [every check-in performs a build and a test pass](/docs/build/define/triggers), will help you identify defects
...
Before migrating your code you should [select a branching strategy](/articles/git-branching-guidance). Using long-lived, isolated
...
Learn more about [managing large files with Git](/docs/git/manage-large-files).
...
and is an excellent starting point. Microsoft also offers a [Git walkthrough](/docs/git/gitquickstart) designed to rapidly get someone up
to speed.
...
- You can [push the repository successfully to Visual Studio Team Services](/docs/git/tutorial/pushing)
